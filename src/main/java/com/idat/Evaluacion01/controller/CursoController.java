...
import com.idat.Evaluacion01.service.CursoService;

@Controller
@RequestMapping( path = "/curso/eva1")
public class CursoController {
	...
	public ResponseEntity<Void> guardar(@RequestBody Curso cursos) {
	...
	public ResponseEntity<Void> actualizar(@RequestBody Curso cursos) {

		Curso c =service.obtenerCursoId(cursos.getIdCurso());
